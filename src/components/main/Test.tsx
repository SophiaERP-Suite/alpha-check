        ...
        <div className="about-wrapper-8">
          <div className="tmp-section-title-border text-start">
            ...
            <h2 className="title w-700 tmp-title-split">
              Lets Know <span className="theme-gradient">About</span> Our <br />{" "}
              Company
            </h2>
          </div>
          <p className="discription">
            Over{" "}
            <span className="odometer" data-count="39,000">
              00000
            </span>{" "}
            ...
            countries all over the This breadth of global coverage, combined
...
c-0.703,1.213-0.543,2.688-0.404,3.406C20.229,6.225,20.387,5.914,20.573,5.593z"
          ...
          <a href="our-service-white.html" className="tmp-btn btn-primary">
            Our Service
          </a>
        </div>
      </div>
