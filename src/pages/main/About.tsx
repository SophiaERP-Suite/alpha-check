const About = () => {
  return (
    <>
              ...
              <div className="tmp-section-title-border text-center">
                <div className="pres-line-separator-wrapper text-center mb--10">
                  ...
                  <span className="subtitle">
                    ...
                    <span className="subtitle-text">About Our Company</span>
                  </span>
                  <div className="line-separator line-right"></div>
                </div>
                <h1 className="title  mt--20">
                  We are a Trusted Background
                  <br />
                ...
                <p className="b1">
                  We deliver secure and reliable DBS solutions for all sectors.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* End Slider Area  */}
      {/* Srart About Area  */}
      <div className="about-area about-style-4 pt--50">
        <div className="container">
...
c-0.703,1.213-0.543,2.688-0.404,3.406C20.229,6.225,20.387,5.914,20.573,5.593z"
      ...
      {/* End About Area  */}
      {/* Mission */}
      <div className="tmp-tab-area  pt-40">
        <div className="container">
          <div className="row mb--40">
            <div className="col-lg-12">
              <div className="section-title text-center">
                <h4 className="subtitle">Our Principles</h4>
              </div>
            </div>
          </div>
                      ...
                      <div className="row gy-5 row--30 align-items-center">
                        <div className="col-lg-6 order-2 order-lg-1">
                          <div className="content">
                              ...
                              <div className="col-lg-6 col-md-6 col-12">
                                <div className="working-list">
                                  ...
                                  <p
                                    ...
                                    data-sal-delay="400"
                                  >
                                    We begin by understanding your needs, goals,
                                    and expectations through clear communication
                                    and assessment.
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="col-lg-6 col-md-6 col-12">
                                <div className="working-list">
                                  ...
                                  <p
                                    ...
                                    data-sal-delay="400"
                                  >
                                    Our experts create a tailored action plan
                                    designed to deliver efficiency, quality, and
                                    measurable outcomes.
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="col-lg-6 col-md-6 col-12">
                                <div className="working-list">
                                  ...
                                  <p
                                    ...
                                    data-sal-delay="400"
                                  >
                                    Each stage is handled with precision and
                                    professionalism to ensure timely and
                              ...
                              <div className="col-lg-6 col-md-6 col-12">
                                <div className="working-list">
                                  ...
                                  <p
                                    ...
                                    data-sal-delay="400"
                                  >
                                    We evaluate results, gather feedback, and
                                    provide ongoing assistance for consistent
                                    client satisfaction..
                                  </p>
                                </div>
                              </div>
                            ...
                            >
                              <a
                                className="tmp-btn round icon-hover"
                                href="/register"
                              >
          ...
          <div className="section-inner">
            ...
            <div className="content">
              ...
              <div className="text">
                ...
                <a href="tel:+442084691888" className="phone">
                  +44 20 8469 1888
                </a>
                <p className="desc">
      ...
      {/* Start Brand Style-1  */}
      <div className="tmp-brand-area tmp-section-gapBottom tmp-section-gapTop">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="tmp-section-title-border text-center">
                <div className="pres-line-separator-wrapper text-center mb--10">
                  ...
                  <span className="subtitle">
                    ...
                    <span className="subtitle-text">Partners</span>
                  </span>
                  <div className="line-separator line-right"></div>
                </div>
                <h2 className="title   tmp-title-split">
